...
import view.AgregarElementoImage;
...
public class ConfiguracionImages
extends JFrame {
    ...
    public void initList() {
        ...
        Vector<String> elementsImage = ManageWords.imagesTest;
        Vector<String> keysImage = ManageWords.imagesObjTest;
        Vector<String> elementsImage2 = ManageWords.images;
        Vector<String> keysImage2 = ManageWords.imagesObj;
        for (i = 0; i < ManageWords.imagesTest.size(); ++i) {
            modelo.addElement(this.getNameImage(elementsImage.get(i)));
            modelo2.addElement(this.getNameImage(keysImage.get(i)));
        }
        for (i = 0; i < ManageWords.images.size(); ++i) {
            modelo3.addElement(this.getNameImage(elementsImage2.get(i)));
            modelo4.addElement(this.getNameImage(keysImage2.get(i)));
        }
    ...
    private void initComponents() {
        ...
        this.jList2.addListSelectionListener(new ListSelectionListener(){
            ...
            public void valueChanged(ListSelectionEvent evt) {
                ConfiguracionImages.this.jList2ValueChanged(evt);
            }
        });
        ...
        this.jList1.addListSelectionListener(new ListSelectionListener(){
            ...
            @Override
            public void valueChanged(ListSelectionEvent evt) {
                ConfiguracionImages.this.jList1ValueChanged(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jButton3ActionPerformed(evt);
            }
        });
        ...
        this.jList3.addListSelectionListener(new ListSelectionListener(){
            ...
            @Override
            public void valueChanged(ListSelectionEvent evt) {
                ConfiguracionImages.this.jList3ValueChanged(evt);
            }
        });
        ...
        this.jList4.addListSelectionListener(new ListSelectionListener(){
            ...
            @Override
            public void valueChanged(ListSelectionEvent evt) {
                ConfiguracionImages.this.jList4ValueChanged(evt);
            }
        });
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jButton4ActionPerformed(evt);
            }
        });
        ...
        this.jMenuItem1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jMenuItem1ActionPerformed(evt);
            }
        });
        ...
        this.jMenuItem2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jMenuItem2ActionPerformed(evt);
            }
        });
        ...
        this.jMenuItem3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jMenuItem3ActionPerformed(evt);
            }
        });
        ...
        this.jMenuItem4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jMenuItem4ActionPerformed(evt);
            }
        });
        ...
        this.jMenuItem5.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jMenuItem5ActionPerformed(evt);
            }
        });
        ...
        this.jMenuItem6.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ConfiguracionImages.this.jMenuItem6ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup((GroupLayout.Group)layout.createParallelGroup(1).add((GroupLayout.Group)layout.createSequentialGroup().addContainerGap().add((Component)this.jPanel1, -2, -1, -2).addPreferredGap(0).add((Component)this.jPanel2, -2, -1, -2).addContainerGap(-1, 32767)));
        layout.setVerticalGroup((GroupLayout.Group)layout.createParallelGroup(1).add((GroupLayout.Group)layout.createSequentialGroup().addContainerGap().add((GroupLayout.Group)layout.createParallelGroup(1, false).add((Component)this.jPanel1, -2, 403, -2).add((Component)this.jPanel2, -1, -1, 32767)).addContainerGap(-1, 32767)));
        this.pack();
    }
    ...
    private String getNameImage(String nameImage) {
    ...
    public void eliminar() throws IOException {
        switch (this.listSelected) {
            case 0: {
                ...
                if (option != 0) break;
                this.manage.removeImage(this.jList3.getSelectedIndex());
                this.manage.updateImages(ManageWords.images, ManageWords.imagesObj);
                break;
            }
            case 1: {
                int option2 = JOptionPane.showConfirmDialog(this, "Se eliminar\u00e1 la pareja. \u00bfDesea eliminar de todos modos?");
                if (option2 != 0) break;
                this.manage.removeImage(this.jList4.getSelectedIndex());
                this.manage.updateImages(ManageWords.images, ManageWords.imagesObj);
                break;
            }
            case 2: {
                ...
                if (option3 != 0) break;
                this.manage.removeImageTest(this.jList1.getSelectedIndex());
                this.manage.updateImagesTest(ManageWords.imagesTest, ManageWords.imagesObjTest);
                break;
            }
            case 3: {
                int option4 = JOptionPane.showConfirmDialog(this, "Se eliminar\u00e1 la pareja. \u00bfDesea eliminar de todos modos?");
                if (option4 != 0) break;
                this.manage.removeImageTest(this.jList2.getSelectedIndex());
                this.manage.updateImagesTest(ManageWords.imagesTest, ManageWords.imagesObjTest);
            }
        }
        this.initList();
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(ConfiguracionImages.class.getName()).log(Level.SEVERE, null, ex);
        }
